...
public class Astronot_hareket : MonoBehaviour //MonoBehavior'dan türetilmiþ aslýnda sizin eklediðiniz her bir c# dosyasý arkada hazýr bir c# dosyasýndan türetülüp buraya konuluyor
{
    ...
    private void FixedUpdate()
    {
        ...
        transform.position += new Vector3(0, dikey * hiz_katsayisi, 0);
